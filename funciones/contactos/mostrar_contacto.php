                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="card  shadow-custom  mb-5 bg-white rounded">
                            <div class="card-body"> 
                                <p class="text-center fw-bold mx-3 mb-0 TColor" style="text-size:50px"> Detalles de contacto </p>
                                <br>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="d-flex flex-column ">
                                                <br>
                                                    <h3 style= "font-family: Arial; font-size: 15px;"> <b> Asunto: </b> <?php echo $usuario['Asunto'];?></h3>
                                                    <br>
                                                    <h3 style= "font-family: Arial; font-size: 15px;"> <b> Mensaje: </b> <?php echo $usuario['Mensaje'];?></h3>
                                                    <br>
                                                </div>
                                            </div>

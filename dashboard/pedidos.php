        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Da seguimiento a los pedidos</p>
                    ...
                    <?php
                        ...
                        if(isset($_GET['enviar'])){
                            ...
                            if (isset($_GET['busqueda'])) {
                                $where="WHERE pedidos.Correo LIKE'%".$busqueda."%' OR nombre  LIKE'%".$busqueda."%'";
                            }
                        }
                    ?>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                            $conexion=$GLOBALS['conex'];                
                                            $SQL=mysqli_query($conexion,"SELECT pedidos.IdCliente, pedidos.Nombre, pedidos.Direccion, pedidos.Celular, pedidos.Pago, pedidos.Espeficicaciones  FROM pedidos");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $fila['Espeficiaciones']; ?></td>
                                            <td>
                                                <a class="btn btn-del" href="acciones/eliminar_pedidos.php?id=<?php echo $fila['Id']?> "> <i class="fa fa-trash"  style="color: black"></i></a>
                                            </td>
                                        </tr>
